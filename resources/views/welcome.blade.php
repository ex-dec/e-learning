                ...
                <div class="w-full px-4">
                    <div class="mb-12 max-w-[620px] lg:mb-20">
                        ...
                        <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                            Menu utama pada Turkish Courses
                        </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                        <div
                            class="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl
                                bg-primary">
                            <span
                                class="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg]
                                    items-center justify-center rounded-2xl bg-primary bg-opacity-20 duration-300
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".15s">
                        ...
                        <p class="mb-8 text-body-color lg:mb-11">
                            Berisi tentang jadwal kegiatan
                        </p>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                        ...
                        <p class="mb-8 text-body-color lg:mb-11">
                            Berisi tentang tugas selama kegiatan berlangsung.
                        </p>
                        <a href="javascript:void(0)" class="text-base font-medium text-body-color hover:text-primary">
                    </div>
                </div>
                        ...
                        <div class="items-center justify-between overflow-hidden border lg:flex">
                            <div
                                ...
                                <h2
                                    ...
                                    Turkish Course by Eccy Abla
                                </h2>
                                <p class="mb-9 text-base leading-relaxed text-body-color">
                                    Turkish Course dapat memudahkan anda belajar Bahasa Turkish. Kami menyediakan
                                    beberapa fitur utama seperti
                                    Materi, Jadwal, Tugas. Lets Join Us
                                </p>
                            </div>
                        </div>
                    </div>
